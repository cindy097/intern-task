...
<!-- tasty food-->
<section class="bg-white py-20 px-6 sm:px-10 md:px-16 xl:px-24">
...
<div class="md:pt-6 lg:pt-16">
  ...
  <p class="text-gray-600 leading-relaxed">
    ...
    <!-- Gambar Section -->
    <div class="flex justify-center md:justify-end gap-4 w-full">
      ...
      <div class="hidden md:flex gap-4">
        <img
          ...
          alt="Salad"
          class="rounded-xl shadow-md w-[160px] lg:w-[200px] xl:w-[220px]"
        >
        <img
          src="{{ asset('img/berita_mini2.jpg') }}"
          alt="Chef"
          class="rounded-xl shadow-md w-[160px] lg:w-[200px] xl:w-[220px] hidden lg:block"
        >
      </div>
