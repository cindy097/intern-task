...
<section id="kontak" class="bg-white py-16 px-4 text-black">
  <div class="max-w-5xl mx-auto">
    <!-- Form Feedback (Hidden by default) -->

    <!-- Judul -->
    <h2 class="text-2xl font-bold mb-8">KONTAK KAMI</h2>
    ...
    <!-- Formulir -->
    <form onsubmit="handleSubmit(event)" class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
      <input
        type="text"
        placeholder="Subject"
        class="w-full border border-black rounded-lg px-4 py-3 text-sm text-black placeholder-gray-500 focus:outline-none"
      />
      <textarea
        placeholder="Message"
        class="w-full h-full min-h-[120px] md:row-span-3 border border-black rounded-lg px-4 py-3 text-sm text-black placeholder-gray-500 focus:outline-none"
      ></textarea>
      ...
      <button
        type="submit"
        class="col-span-1 md:col-span-2 bg-black text-white font-semibold py-4 rounded-lg hover:opacity-90 transition"
      >
        KIRIM
      </button>
    </form>
